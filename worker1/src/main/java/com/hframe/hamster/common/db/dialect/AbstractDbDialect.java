...
import com.hframe.hamster.common.meta.DdlUtils;
import com.hframe.hamster.common.meta.DdlUtilsFilter;
...
//    protected DataSourceService        dataSourceService;
    ...
    private void initTables(final JdbcTemplate jdbcTemplate) {
        ...
        mapMaker = new MapMaker().softValues();//TODO 因为guava升级兼容新问题临时注掉
//        // .evictionListener(new MapEvictionListener<List<String>, Table>() {
//
