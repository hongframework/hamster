 ...
 */
public class MinuteReduceTask extends AbstractReduceTask implements FlowNodeTask{

    public MinuteReduceTask(FlowKey flowKey, PrototypeKey prototypeKey) {
    ...
    protected String tableName() throws Exception {
        return "hamster_statistics_minute";
    }
