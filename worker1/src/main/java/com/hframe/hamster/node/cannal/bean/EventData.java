...
public class EventData implements ObjectData, Serializable {
     ...
     * 变更前的所有值 add by zqh
     */
    private List<EventColumn> oldColumns          = new ArrayList<EventColumn>();
    ...
    public EventData clone() {
        ...
        data.setBinLogPostion(binLogPostion);
        data.setSql(sql);
    ...
    public int hashCode() {
        ...
        result = prime * result + ((oldColumns == null) ? 0 : oldColumns.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (oldColumns == null) {
            if (other.oldColumns != null) return false;
        } else if (!oldColumns.equals(other.oldColumns)) return false;
    ...
    public void setBinLogPostion(String binLogPostion) {
        this.binLogPostion = binLogPostion;
    }

    public String getBinLogPostion() {
