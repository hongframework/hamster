 ...
 */
public class SecondReduceTask extends AbstractReduceTask implements FlowNodeTask {

    public SecondReduceTask(FlowKey flowKey, PrototypeKey prototypeKey) {
    ...
    protected String tableName() throws Exception {
        return "hamster_statistics_second";
    }

    @Override
    public Class<? extends FlowTask> prevTask() {
        return HBaseSelectTask.class;
    }
