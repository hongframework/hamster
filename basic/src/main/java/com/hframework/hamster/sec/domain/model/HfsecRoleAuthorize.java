...
public class HfsecRoleAuthorize {
    ...
    public HfsecRoleAuthorize(Long hfsecRoleAuthorizeId, Byte hfsecRoleAuthorizeType, Long hfsecRoleId, Long hfsecMenuId, Byte status, Long creatorId, Date createTime, Long modifierId, Date modifyTime) {
