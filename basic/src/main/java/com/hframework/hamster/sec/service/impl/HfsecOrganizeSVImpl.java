...
import com.hframework.hamster.sec.service.interfaces.IHfsecOrganizeSV;
import org.springframework.stereotype.Service;
import javax.annotation.Resource;
import com.google.common.collect.Lists;
import com.hframework.common.util.ExampleUtils;
import com.hframework.hamster.sec.domain.model.HfsecOrganize;
import com.hframework.hamster.sec.domain.model.HfsecOrganize_Example;
import com.hframework.hamster.sec.dao.HfsecOrganizeMapper;
import com.hframework.hamster.sec.service.interfaces.IHfsecOrganizeSV;
...
public class HfsecOrganizeSVImpl  implements IHfsecOrganizeSV {
    ...
    */
    ...
    private void fillHfsecOrganizeTreeCascade(Map<Long, List<HfsecOrganize>> result, List<Long> parentIds, HfsecOrganize_Example templateExample)  throws Exception {
        if(parentIds.size() == 0) {
            return ;
        }
        if(templateExample == null) {
            templateExample = new HfsecOrganize_Example();
        }
        HfsecOrganize_Example example = ExampleUtils.clone(templateExample);
        ...
        fillHfsecOrganizeTreeCascade(result,subIds, templateExample);
    }
