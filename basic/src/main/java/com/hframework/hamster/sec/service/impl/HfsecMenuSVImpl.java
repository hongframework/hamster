...
import com.hframework.hamster.sec.dao.HfsecMenuMapper;
import com.hframework.hamster.sec.service.interfaces.IHfsecMenuSV;
...
public class HfsecMenuSVImpl  implements IHfsecMenuSV {
    ...
    */
    public Map<Long, List<HfsecMenu>> getHfsecMenuTreeByParentId(HfsecMenu hfsecMenu, HfsecMenu_Example example)  throws  Exception {
        ...
        fillHfsecMenuTreeCascade(result, Lists.newArrayList(
                hfsecMenu.getParentHfsecMenuId() == null ? -1 : hfsecMenu.getParentHfsecMenuId() ), example);
        return result;
    }
